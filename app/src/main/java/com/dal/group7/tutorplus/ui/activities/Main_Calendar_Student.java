...
public class Main_Calendar_Student extends AppCompatActivity {
    ...
    List<String> list;
    String text;
    DBhelper dbHelper = new DBhelper(Main_Calendar_Student.this);
    Resources res;
    ...
    ArrayList<TimingAvailablity>  listofAvailableTimesByDate;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cal_student_layout);
        res = getResources();
        loadCalendar();
...
/*        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dateString.isEmpty() || dateString.length()==0 || dateString.equals("") || dateString == null){
                    ...
                    if(descString.isEmpty() || descString.length()==0 || descString.equals("") || descString == null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Main_Calendar_Student.this);
                   ...
                   // listofAvailableTimesByDate = dbHelper.fetchAvailablitybyDate(dbHelper.getWritableDatabase(),0,"12/12/2017");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.add:
                Intent i = new Intent(Main_Calendar_Student.this,DisplayEventActivity.class);
                startActivity(i);
        }
